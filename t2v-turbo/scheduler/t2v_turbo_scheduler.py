...
class T2VTurboScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        denoised = c_out * pred_x0 + c_skip * sample  # (x_t-1 | x_0, x_t)

        # 6. Sample z ~ N(0, I), For MultiStep Inference
        # "noise" is normally random, but if `variance_noise` is provided, use that instead
